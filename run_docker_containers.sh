...
docker run -p 3000:3000 -d --name pub-sub-oracle-frontend --network=pub-sub-oracle-network --env REACT_APP_ENV=PROD --env REACT_APP_BASE_URL=$1 paulsbecks/pub-sub-oracle-frontend 
