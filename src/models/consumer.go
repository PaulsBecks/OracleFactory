...
func GetConsumerByID(ID uint) *Consumer {
...
func (s *Consumer) GetSmartContract() *SmartContract {
	return GetSmartContractByID(s.SmartContractID)
}

func (iot *Consumer) GetEventParameterJSON() string {
	json := "["
...
func (s *Consumer) GetListenerPublisher() ListenerPublisher {
	return GetListenerPublisherByID(s.ListenerPublisherID)
}

func (s *Consumer) Publish(pubSubOracle *PubSubOracle, event *Event) error {
	user := pubSubOracle.GetOracle().GetUser()
...
func (s *Consumer) CreateEthereumTransaction(user *User, event *Event) error {
...
func (s *Consumer) CreateHyperledgerTransaction(user *User, event *Event) error {
